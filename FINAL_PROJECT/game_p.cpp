...
game_p::game_p()  //konstruktor bazowy
{
...
game_p::game_p(vector<country> v, parasite md, dna d) //konstruktor parametryczny
{
    all_countries=v;
    my_disease=md;
    my_dna = d;
...
void game_p::init() //tworzy ustalona mape i chorobe o wybranych parametrach
{
...
void game_p::user_turn() //tura gracza i rzeczy ktore on moze zrobic
{
...
void game_p::game_turn() //rzeczy ktore sie dzieja behind the scenes, poza kontrola gracza
{
...
bool game_p::is_this_the_end() //sprawdza czy gra sie skonczyla, jesli tak, z jakim rezultatem
{
...
void game_p::the_game() //trwanie gry
...
void game_p::game_current_state() //informacje o obecnym przebiegu gry 
{
