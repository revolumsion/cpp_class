...
game_b::game_b()  //konstruktor bazowy
{
...
game_b::game_b(vector<country> v, bacteria md, dna d) //konstruktor parametryczny
{
    all_countries=v;
    my_disease=md;
    my_dna = d;
...
void game_b::init() //tworzy ustalona mape i chorobe o wybranych parametrach
{
...
void game_b::user_turn() //tura gracza i rzeczy ktore on moze zrobic
{
...
void game_b::game_turn() //rzeczy ktore sie dzieja behind the scenes, poza kontrola gracza
{
...
bool game_b::is_this_the_end() //sprawdza czy gra sie skonczyla, jesli tak, z jakim rezultatem
{
...
void game_b::the_game() //trwanie gry
...
void game_b::game_current_state() //informacje o obecnym przebiegu gry 
{
