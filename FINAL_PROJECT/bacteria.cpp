#include"bacteria.hxx"
 ...
 //metody fabularne
    void bacteria::evolve(int& dp) //metoda ewolucji choroby (poprawy statów)
    {
        char choice;
    ...
    void bacteria::spread(vector<country>& neighbours, country& me, float chance1, float chance2) //metoda rozprzestrzeniania sie choroby
    {
    ...
    void bacteria::what_are_my_stats() //wypisuje na terminalu obecne paraemtry wirusa
    {
    ...
    //constructors
    bacteria::bacteria() //konstruktor bazowy
    {
        name = "Przeziebienie";
        spreadability = 0.2;
        deadly = 0.0;
    ...
    bacteria::bacteria(string n) //konstruktor parametryczny
    {
        name = n;
        spreadability = 0.2;
        deadly = 0.0;
