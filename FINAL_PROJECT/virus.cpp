#include"virus.hxx"
 ...
 //metody fabularne
    void virus::evolve(int& dp) //metoda ewolucji choroby (poprawy statów)
    {
        char choice;
        ...
        case 's': //CHEAT CODE do wizualizacji wymaxowaniego wirusa (spreadability)
        {
            spreadability =1;
            break;
        }
    ...
    void virus::spread(vector<country>& neighbours, country& me, float chance1, float chance2) //metoda rozprzestrzeniania sie choroby
    {
    ...
    void virus::what_are_my_stats() //wypisuje na terminalu obecne paraemtry wirusa
    {
    ...
    //constructors
    virus::virus() //konstruktor bazowy
    {
        name = "Coronavirus";
        spreadability = 0.3;
        deadly = 0.2;
    ...
    virus::virus(string n) //konstruktor parametryczny
    {
        name = n;
        spreadability = 0.3;
        deadly = 0.2;
